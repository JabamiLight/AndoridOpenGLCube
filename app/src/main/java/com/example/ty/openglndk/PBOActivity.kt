...
import com.example.ty.openglndk.R.id.surface
import com.example.ty.openglndk.R.id.tv_frame
...
class PBOActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        op.inSampleSize = 2
        var a = BitmapFactory.decodeResource(resources, R.mipmap.pic7, op)
